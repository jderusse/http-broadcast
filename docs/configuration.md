...
| `HUB_TOPIC`                   | `http-broadcast` | name of the Mercure's topic to exchange messages. This parameter can also be define with by the queryString of `HUB_ENDPOINT`. example `HUB_ENDPOINT=https://example.com/hub?topic=my_topic`. |
